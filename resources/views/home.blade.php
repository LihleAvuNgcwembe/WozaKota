...
<body>
    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <div id="middle">
                <button class="delco"><a href="https://www.ubereats.com/za/store/woza-woza-kota-place-glen-austin/giGq8iNHS4-klM_Su6c0Og" text-decoration: none;>Delivery</a></button>

                <h2
                    style="font-family: 'trebuchet MS', sans-serif; font-size: 28px; color: #faf9f6; text-align: center; padding: 20px;">
                    or</h2>

                <button class="delco"><a href="{{ route('menu') }}">Collection</a></button>
            </div>
