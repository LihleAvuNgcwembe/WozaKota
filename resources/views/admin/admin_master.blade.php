...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/img/Woza-Woza-Kota-Logo.png') }}">
    <title>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('admin.dashboard') }} " target="_blank">
                <img src="{{ asset('assets/img/Woza-Woza-Kota-Logo.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
                <span class="ms-1 font-weight-bold">Woza Woza Kota</span>
            </a>
        </div>
